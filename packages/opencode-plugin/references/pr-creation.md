...
- [ ] All tests pass locally (`bun test packages/opencode-plugin/` — deliberate top-rung run; day-to-day work uses scoped runs per `references/test-authoring.md` ## Test Execution Discipline)
