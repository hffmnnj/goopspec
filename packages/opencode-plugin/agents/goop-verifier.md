...
2. `Read(".goopspec/<workflowId>/SPEC.md")` — must-haves and acceptance criteria.
3. `Read(".goopspec/<workflowId>/BLUEPRINT.md")` — traceability and tasks.
4. `Read(".goopspec/<workflowId>/CHRONICLE.md")` — execution evidence.
